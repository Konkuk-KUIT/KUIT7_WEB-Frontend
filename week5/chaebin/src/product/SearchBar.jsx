...
export default function SearchBar({onFilterTextChange, onInStockOnlyChange, filterText, inStockOnly}) {
    ...
    return(
        <form>
            ...
            <label for={stockCheckboxId}>
                <input type="checkbox" id={stockCheckboxId} onChange={handleInStockOnlyChange}/>{" "}
